...
public class CreatePortfolioTest extends BaseTest {
    ...
    public void createPortfolioTest(Hashtable<String, String > data) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        if ((DataUtil.isTestSkip(testName, xls)) || (!data.get(Constants.RUNMODE_COL).equals("Y"))) {
